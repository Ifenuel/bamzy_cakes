...
const EVENT_TYPES = [
  { title: 'Birthday Parties', desc: 'Custom cakes, small chops and full catering for unforgettable celebrations.', img: '/uploads/products/cupcake.jpg' },
  { title: 'Weddings', desc: 'Beautiful wedding cakes, dessert tables and catering for your big day.', img: '/uploads/products/buttercream-cake.jpg' },
  { title: 'Bridal Showers', desc: 'Sweet treats and elegantly packaged pastries for the bride-to-be.', img: '/uploads/products/cake-parfait.jpg' },
  { title: 'Baby Showers', desc: 'Adorable cakes and treats to welcome the newest arrival.', img: '/uploads/products/vanilla-cake-loaf.jpg' },
  { title: 'Corporate Events', desc: 'Professional catering for meetings, launches and company parties.', img: '/uploads/products/whipped-cream-cake.jpg' },
  { title: 'Private Celebrations', desc: 'Anniversaries, graduations and milestone moments deserve Bamzy treats.', img: '/uploads/products/foil-cake.jpg' },
]
...
function EventsBookImage() {
  const [imgError, setImgError] = useState(false)
  const imgSrc = getImgUrl('/uploads/products/buttercream-cake.jpg')
  if (imgSrc && !imgError) {
    return (
      <div className="overflow-hidden rounded-xl shadow-soft">
        <img src={imgSrc} alt="Beautiful Bamzy cake for your event" className="h-64 w-full object-cover sm:h-80" onError={() => setImgError(true)} />
      </div>
    )
  }
  return (
      ...
      <section className="py-10 sm:py-14">
        <PageContainer>
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {EVENT_TYPES.map(({ title, desc, img }, i) => (
